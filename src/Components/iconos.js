...
function Iconos(){
    ...
    <div className="container-icons">
        <a href=""><div className="row-icon icon1"><h4>Facebook</h4><label className="fab fa-facebook-square label1"></label></div></a>
        <a href=""><div className="row-icon icon2"><h4>Whatsapp</h4><label className="fab fa-whatsapp-square label2"></label></div></a>
        <a href=""><div className="row-icon icon3"><h4>Instagram</h4><label className="fab fa-instagram-square label3"></label></div></a>
